...
public class COSClientUtil {
    ...
    private static final String bucketName = "iamten-1253464268";

    //secretId 			替换成自己的

    private static final String secretId = "AKIDbEl8KKbkS1QLPMrB1jHepogMsHamagLr";

    // secretKey		        替换成自己的

    private static final String secretKey = "ndY6e1EVjoiR0NchaMwJG6kDUcZK4lGZ";
    ...
    public String uploadFile2Cos(MultipartFile file) throws Exception {
        ...
        String name = filedir + random.nextInt(10000) + System.currentTimeMillis() + substring;
