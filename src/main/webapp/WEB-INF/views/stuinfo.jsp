            ...
            <form class="layui-form" action="updateinfo" lay-filter="example">
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input name="stuid"  autocomplete="off" class="layui-input" type="text" value="${sessionScope.userinfo.stuid}" readonly>
                        </div>
                        <label class="layui-form-label">姓名</label>
                        <div class="layui-input-inline">
                            <input name="sname"  autocomplete="off" readonly class="layui-input" type="text" value="${sessionScope.userinfo.sname}">
                        </div>
                        <label class="layui-form-label">班级</label>
                        <div class="layui-input-inline">
                            <input name="sclass"  autocomplete="off" readonly class="layui-input" type="text" value="${sessionScope.userinfo.sclass}">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <c:set var="getsex" scope="page" value="${sessionScope.userinfo.ssex}"/>
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input name="sbirthday" class="layui-input" id="date" type="text" placeholder="yyyy-MM-dd" autocomplete="off" lay-verify="date" value="${sessionScope.userinfo.sbirthday}">
                        </div>
                        <label class="layui-form-label">生源地</label>
                        <div class="layui-input-inline">
                            <input name="students"  autocomplete="off" class="layui-input" type="text" value="${sessionScope.userinfo.students}">
                        </div>
                        <label class="layui-form-label">政治面貌</label>
                        <div class="layui-input-inline">
                            <c:set var="getmilitarists" scope="page" value="${sessionScope.userinfo.spolitical}"/>
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input name="sphone"  autocomplete="off" class="layui-input" type="text" maxlength="11" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" value="${sessionScope.userinfo.sphone}">
                        </div>
                        <label class="layui-form-label">邮箱</label>
                        <div class="layui-input-inline">
                            <input name="semail"  autocomplete="off" class="layui-input" type="email" value="${sessionScope.userinfo.semail}">
                        </div>
                        <label class="layui-form-label">寝室</label>
                        <div class="layui-input-inline">
                            <input name="dormitory"  autocomplete="off" class="layui-input" type="text" value="${sessionScope.userinfo.sadress}">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
