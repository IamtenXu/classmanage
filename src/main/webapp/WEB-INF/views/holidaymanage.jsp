    ...
    layui.use(['element','table','form'], function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'province',  sort: true, title: '省',width: 80}
                ,{field:'city',   sort: true,title: '市',width: 80}
                ,{field:'area',   sort: true,title: '县/区/县级市',width: 120}
                ,{field:'emergencyname', align: 'left', title: '紧急联系人',width: 100}
                ,{field:'emergencyphone', title: '紧急联系人联系方式',width: 160}
