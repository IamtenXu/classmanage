            ...
            <form class="layui-form" action="" lay-filter="example">
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <button class="layui-btn dw-dailog" dw-url="/workanalysis" dw-title="工作情况分析" type = "button">分析</button>
                        </div>
                    </div>
                </div>
            </form>
    ...
    layui.use(['element','table'], function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'isrent',align: 'center',  sort: true,title: '状态', templet: '#tpl_demo'}
