...
<div>
    <div>
        <div style="padding: 10px;">
            ...
            <form class="layui-form" action="/school/schoolcheck" lay-filter="example">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <select id="status" name="status"  lay-verify="required" lay-filter="statusFilter">
                                ...
                                <option value="1">已过笔试</option>
                                <option value="2">已过复试</option>
                            </select>
                        </div>
                    </div>
                </div>
                <div class="layui-form-item" id="companyform">
                    <%--<div class="layui-inline">--%>
                        <label class="layui-form-label"><font color="red" size="4">*</font>学校</label>
                        <div class="layui-input-block" style="width:514px;">
                            <input name="schoolname"  id= "company" autocomplete="off" placeholder="请如实填写，方便统计。" lay-verify="required" class="layui-input" type="text" value="">
                        </div>
                    <%--</div>--%>
                </div>
                <div class="layui-form-item">
                    <div class="layui-input-block">
                        <button class="layui-btn" lay-submit="" lay-filter="updateschool">立即提交</button>
                        <input type="button" class="layui-btn layui-btn-warm" value="重置" onclick="location.href='/school'">
                    </div>
                </div>
            </form>
        </div>
    ...
    layui.use(['form', 'laydate'], function(){
        ...
        $.ajax({
            ...
            success: function (data) {
                if(data.is === 1){
                    $("#company").val(data.school.school);
                    $("#status").val(data.school.status);
                    form.render('select');
                }
            }
        });
