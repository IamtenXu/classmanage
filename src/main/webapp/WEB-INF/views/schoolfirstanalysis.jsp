    ...
    layui.use(['element','form','laydate'], function(){
        ...
        form.on('select(classidFilter)', function(){
            $.ajax({
                ...
                success: function (data) {
                    $('#formcontainer').empty();
                    $('#formcontainer').append("<label><font size='5'> 通过笔试人数为<strong> "+data.sum+"</strong>人，"+"考研人数为<strong> "+data.all+"</strong>人，通过的比例为<strong> "+data.schoolpercent+"</strong></font></label><br>");
